...
public class ActivityDataLokalAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_lokal_add);

        Toolbar toolbar = findViewById(R.id.toolbar);
        toolbar.setBackground(getResources().getDrawable(R.color.colorPrimary));
        setSupportActionBar(toolbar);
        this.setTitle("Offline Data Tambah Toko");
    ...
    public void onResume(){
        ...
        AsyncJob.doInBackground(new AsyncJob.OnBackgroundJob() {
            ...
            public void doOnBackground() {
                ...
                RealmResults<TbTambahToko> visitToko = realm.where(TbTambahToko.class).sort("tgl_add", Sort.DESCENDING).findAll();
                ...
                if(visitToko.size() > 0){
                    ...
                    */
                    ...
                    listView.setAdapter(new ListAdapterDataOffline(ActivityDataLokalAdd.this, data));
                    ...
                    AsyncJob.doOnMainThread(new AsyncJob.OnMainThreadJob() {
                        ...
                        public void doInUIThread() {
                            ...
                            Toast.makeText(ActivityDataLokalAdd.this, "Belum ada data lokal tersimpan", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    });
                }
